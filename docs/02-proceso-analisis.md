...
- [Proceso de análisis](#proceso-de-análisis)
  ...
  - [Preparación de datos](#preparación-de-datos)
    - [1. Carga del conjunto de datos](#1-carga-del-conjunto-de-datos)
    - [2. Normalización de nombres de columnas](#2-normalización-de-nombres-de-columnas)
    - [3. Selección de variables relevantes](#3-selección-de-variables-relevantes)
    - [4. Conversión de tipos y limpieza de valores](#4-conversión-de-tipos-y-limpieza-de-valores)
    - [5. Detección y eliminación de filas inválidas](#5-detección-y-eliminación-de-filas-inválidas)
    - [6. Generación de tablas auxiliares](#6-generación-de-tablas-auxiliares)
    - [7. Guardado del CSV limpio](#7-guardado-del-csv-limpio)
    - [8. Preparación para la carga a base de datos](#8-preparación-para-la-carga-a-base-de-datos)
